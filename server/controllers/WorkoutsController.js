...
export class WorkoutsController extends BaseController {
  constructor() {
    ...
    this.router = express.Router()
      ...
      .put('/:id/removeDay', this.removeDay)
      .put('/:id/editExercise', this.editExercise)
      .delete('/:id', this.delete)
      .delete('/:workoutId/exercise/:exerciseId', this.deleteExercise)
  }
  ...
  async removeDay(req, res, next) {
    try {
      let data = await workoutsService.removeDay(req.params.id, req.userInfo.email, req.body)
      return res.send(data)
    } catch (error) { next(error) }
  }
  ...
  async deleteExercise(req, res, next) {
    try {
      await workoutsService.deleteExercise(req.params.workoutId, req.params.exerciseId)
